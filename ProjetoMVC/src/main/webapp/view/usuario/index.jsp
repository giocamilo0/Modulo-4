...
<body>
				...
				<div class="row">
					<div class="col">
						<ul class="list-group list-group-horizontal  ajust-nav-sm">
							...
							<li class="list-group-item">
								<a class="link" href="./usuariosS.html">Usuarios</a>
							</li>
							<li class="list-group-item">
								<a class="link" href="./passagens.html">Destinos</a>
							</li>	
						</ul>
					</div>
				</div>
	...
	<header class="container my-4">
		<div class="row">
			<div class="col">
				<a class="btn btn-info" href="./view/usuario/cadastrar.html">Cadastrar Usuário</a>
	...
	<table class="table container">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a class="btn btn-success" href="editar-usuario?id=<%=a.getId_usuario()%>">Atualizar</a>
